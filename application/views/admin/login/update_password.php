    ...
    <div class="col-md-4">
        <div class="panel">
            <div class="panel-heading">
                <div class="panel-title"> <i class="fa fa-pencil"></i>Reset Password </div>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url(). 'login/ForgotPassword/'?>update_password"/>
                ...
                <div class="form-group">
                    <label for="inputStandard" class="col-lg-2 control-label">New Password</label>
                    <div class="col-lg-8">
                        <input type="text" id="inputStandard" class="form-control" name="pwd" placeholder="Type Here..." />
                    </div>
                    <div>
