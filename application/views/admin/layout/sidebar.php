  ...
  <aside id="sidebar">
    ...
    <div id="sidebar-menu">
      <ul class="nav sidebar-nav">
        ...
        <li class="active"> <a href="dashboard.html"><span class="glyphicons glyphicons-star"></span><span class="sidebar-title">Dashboard</span></a> </li>
        <li> <a class="accordion-toggle" href="#resources"><span class="glyphicons glyphicons-settings"></span><span class="sidebar-title">Resources</span><span class="caret"></span></a>
          <ul id="resources" class="nav sub-nav menu-open">
            <li><a href="customizer.html"><span style="width: 15px;" class="glyphicons glyphicons-edit"></span> Theme Customizer</a></li>
        ...
        <li> <a class="accordion-toggle collapsed" href="#sideTwo"><span class="glyphicons glyphicons-vcard"></span><span class="sidebar-title">Form Elements</span><span class="caret"></span></a>
