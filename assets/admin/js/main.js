    ...
    var runPrepJS = function () {
		...
		$(window).load(function() {
			...
			var scripts = {
				...
				// HIGH PRIORITY
				gmap: 			 'http://localhost/template/assets/admin/vendor/plugins/map/gmaps.min.js',
				jquerymap:		 'http://localhost/Template/assets/admin/vendor/plugins/gmap/jquery.ui.map.js',
				mixitup: 		 'http://localhost/Template/assets/admin/vendor/plugins/mixitup/jquery.mixitup.min.js',
				mpopup: 		 'http://localhost/Template/assets/admin/vendor/plugins/mfpopup/dist/jquery.magnific-popup.min.js',
				chosen:		  	 'http://localhost/Template/assets/admin/vendor/plugins/chosen/chosen.jquery.min.js',
				moment:		 	 'http://localhost/Template/assets/admin/vendor/plugins/daterange/moment.min.js',
				globalize:   	 'http://localhost/Template/assets/admin/vendor/plugins/globalize/globalize.js',
	
				// FORM PICKERS
				cpicker: 	  	 'http://localhost/Template/assets/admin/vendor/plugins/colorpicker/bootstrap-colorpicker.js',
				timepicker:      'http://localhost/Template/assets/admin/vendor/plugins/timepicker/bootstrap-timepicker.min.js',
				datepicker:      'http://localhost/Template/assets/admin/vendor/plugins/datepicker/bootstrap-datepicker.js',
				daterange: 	     'http://localhost/Template/assets/admin/vendor/plugins/daterange/daterangepicker.js',
				
				// FORMS
				validate:		 'http://localhost/Template/assets/admin/vendor/plugins/validate/jquery.validate.js',
				masked: 	 	 'http://localhost/Template/assets/admin/vendor/plugins/jquerymask/jquery.maskedinput.min.js',
				
				// FORMS TOOLS
				holder: 	     'http://localhost/Template/assets/admin/vendor/bootstrap/holder.js',
				tagmanager:      'http://localhost/Template/assets/admin/vendor/plugins/tags/tagmanager.js',
				gritter:         'http://localhost/Template/assets/admin/vendor/plugins/gritter/js/jquery.gritter.min.js',
				ladda:           'http://localhost/Template/assets/admin/vendor/plugins/ladda/ladda.min.js',
				switcher:        'http://localhost/Template/assets/admin/vendor/plugins/formswitch/js/bootstrap-switch.min.js',
				paginator:		 'http://localhost/Template/assets/admin/vendor/bootstrap/paginator/src/bootstrap-paginator.js',
				knob:            'http://localhost/Template/assets/admin/vendor/plugins/jquerydial/jquery.knob.js',
				rangeslider:     'http://localhost/Template/assets/admin/vendor/plugins/rangeslider/jQAllRangeSliders.min.js',
				
				// MED PRIORITY - Large File sizes
				charts:       	 'http://localhost/Template/assets/admin/js/charts.js',
				ckeditorCDN:     'http://cdnjs.cloudflare.com/ajax/libs/ckeditor/4.0.1/ckeditor.js',
				xedit: 			 'http://localhost/Template/assets/admin/vendor/editors/xeditable/js/bootstrap-editable.js',
				summernote:      'http://localhost/Template/assets/admin/vendor/editors/summernote/summernote.js',
				elfinder: 		 'http://localhost/Template/assets/admin/vendor/plugins/elfinder/js/elfinder.min.js',
				countdown:       'http://localhost/Template/assets/admin/vendor/plugins/countdown/jquery.countdown.js',
				jcrop: 			 'http://localhost/Template/assets/admin/vendor/plugins/imagecrop/js/jquery.Jcrop.min.js',
				imagezoom: 		 'http://localhost/Template/assets/admin/vendor/plugins/imagezoom/jquery.elevatezoom.min.js',
				sketchpad:       'http://localhost/Template/assets/admin/vendor/plugins/notepad/wPaint.min.js',
				scrollto: 		 'http://localhost/Template/assets/admin/vendor/plugins/scrollto/jquery.scrollTo-1.4.3.1-min.js',
				fileupload:      'http://localhost/Template/assets/admin/vendor/bootstrap/fileupload/fileupload.js',
				fitvids:		 'http://localhost/Template/assets/admin/vendor/plugins/fitvids/jquery.fitvids.js'	,
